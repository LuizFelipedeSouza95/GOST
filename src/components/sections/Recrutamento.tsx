export default function Recrutamento() {
    return (
		<section id="recrutamento">
			<h1 className="text-4xl font-bold text-slate-800 mb-3">TÓPICO II. INGRESSO E AVALIAÇÃO (Q&A)</h1>
			...
			<div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
					<h2 className="text-2xl font-semibold text-slate-700 mb-3">1. Requisitos Básicos</h2>
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
					<h2 className="text-2xl font-semibold text-slate-700 mb-3">2. Fase de Recrutamento (Q&A)</h2>
                    <ul className="list-disc list-inside space-y-3 text-lg text-gray-700">
                        <li>
