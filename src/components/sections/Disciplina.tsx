export default function Disciplina() {
    return (
		<section id="disciplina">
			<h1 className="text-4xl font-bold text-slate-800 mb-3">TÓPICO III. CONDUTA E DISCIPLINA</h1>
			<p className="text-lg text-gray-700 mb-3">Este tópico estabelece a <strong>doutrina disciplinar</strong> da GOST.</p>
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 border">
                    <h2 className="text-2xl font-semibold text-slate-700">2. Faltas e Remoção</h2>
                    <p className="text-lg text-gray-700">
